...
- [MolmoBot-Data](https://huggingface.co/datasets/allenai/MolmoBot-Data) (paper <https://arxiv.org/abs/2603.16861>, code <https://github.com/allenai/MolmoBot>) — simulation training source: Franka tabletop subset; run-1 corpus is the plain Pick-and-Place config only, train shards 0–100 of 1,598 (plan decision D-31).
...
- [GWM training](../../gwm_wiser/scripts/gwm_train.py) — the reference trainer `real_data_train/train.py` mirrors.
