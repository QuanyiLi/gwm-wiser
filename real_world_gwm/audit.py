...
are violations, not curiosities.
    ...
    python -m real_world_gwm.audit --data_root real_world_gwm/data \\
...
from real_world_gwm.windows import DEFAULT_TOLERANCE_S, enumerate_timed_windows
...
def build_manifest(
    ...
    for clip in clips:
        ...
        max_err = 0.0
        ts = clip.timestamps
        from real_world_gwm.windows import SCHEDULE
