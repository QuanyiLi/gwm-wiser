...
ADRs are numbered in decision order. Status is explicit because later decisions may supersede earlier experiment assumptions.
...
| [0005](0005-use-ordinal-six-frame-windows.md) | Accepted | Use ordinal six-frame windows when VRS is used |
...
| [0008](0008-treat-wiser-as-development-evaluation.md) | Accepted | Treat WISER as development evaluation |
| [0009](0009-restrict-vrs-use-to-research.md) | Accepted | Restrict VRS use to research |
