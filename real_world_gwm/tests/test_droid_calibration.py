...
from real_world_gwm.scripts.prepare_droid_calibration import (
    build_calibration,
    extrinsic_for,
    keep_ranges_for,
    triple_index,
)
from real_world_gwm.scripts.render_actions import segment_keep_ranges
...
def test_load_calibrations_scales_intrinsics(tmp_path):
    root = _write_synthetic_root(tmp_path)
    from real_world_gwm.scripts import prepare_droid_calibration as prep
    from real_world_gwm.sources.molmoact2_droid import load_calibrations
