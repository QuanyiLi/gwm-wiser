...
INSTR[nearbowl]="pick up the object closest to the bowl";                    RULE[nearbowl]='{"objects":["cube"],"lift":0.15}'
...
INSTR[container]="pick up the container";                                    RULE[container]='{"objects":["bowl"],"lift":0.15}'
